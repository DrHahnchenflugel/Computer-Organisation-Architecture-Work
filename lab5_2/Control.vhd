...
BEGIN
	...
	PROCESS (present_state, Instruction_sig)
	BEGIN
		 en  <= '0';
		 wen <= '0';

		 IF (present_state = state_1 OR present_state = state_2) THEN

			  -- LDA / LDB
			  IF (Instruction_sig = "1001" OR Instruction_sig = "1010") THEN
					en  <= '1';
					wen <= '0';

			  -- STA / STB
			  ELSIF (Instruction_sig = "0010" OR Instruction_sig = "0011") THEN
					en  <= '1';
					wen <= '1';
			  END IF;
	...
	WITH present_state select
		T	<= "001" when state_0,
				"010" when state_1,
				"100" when state_2,
				"000" when others; --note to be not current state
END description;